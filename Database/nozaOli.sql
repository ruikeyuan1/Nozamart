...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2022 at 06:31 PM
...
(1, 'oliver1', 'Keke1234', 23, 'oliveraarland62@gmail.com\noliveraarland62@gmail.co', 'Oliver', 'Aarland'),
(2, 'kekett', 'keke123', 8, 'oliver.aarland@yahoo.no', '', ''),
(3, 'Colonelu\'', 'Alin2002', 20, '', '', '');
...
CREATE TABLE `pwdreset` (
  ...
  `pwdResetToken` varchar(50) NOT NULL,
  `pwdResetExpires` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('oliver.aarland@yahoo.no', '378417d901263e0c', '$2y$10$O2teDexG8ezAKS/zciqZHOOGXsxmOVm.4LJZ1E9QK1c', '1646407660'),
('oliveraarland62@gmail.com', '13ae6141a3c9367c', '$2y$10$WpM/kzvlAJcqLRVSUDw1i.QuHUqIj20nS5zOY3zSHTs', '1646409254');
